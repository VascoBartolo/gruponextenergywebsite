    ...
    <div className="container py-16 grid md:grid-cols-4 gap-10">
      <div className="md:col-span-2 space-y-4">
        <Link to="/" aria-label="Grupo Nextenergy — início" className="inline-flex">
          <img src={groupLogoWhite} alt="Grupo Nextenergy" className="h-11 w-auto object-contain" />
        </Link>
      ...
      <div>
        ...
        <ul className="space-y-3 text-sm text-background/70">
          <li className="flex items-center gap-2"><Mail size={14} className="text-primary" /> geral@gruponextenergy.pt</li>
